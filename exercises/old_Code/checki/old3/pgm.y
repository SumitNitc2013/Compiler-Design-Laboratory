...
%token NUM ID1 ID2 READ WRITE IF THEN ENDIF WHILE DO ENDWHILE BEGIN1 END1 DECL ENDDECL INT BOOL ELSE
%left '<' '>' '#'
%left '+' '-'
%left '*' '/'
%right '^'
...
%%
	...
	id: ID1  {insert_id(make_id_node($1->NAME,1,$1));if(id_head!=NULL) printf("idlist formed\n");}
	  | ID1'['NUM']' {insert_id(make_id_node($1->NAME,$3->val,$1));}     
	  ;
	...
	stmt: ID2'='E';'       {char c[10];strcpy(c,"=");$$=makeNameNode(c,$1,NULL,$3);}
		| ID2'['E']' '=' E ';'   {char c[10];strcpy(c,"=");$$=makeNameNode(c,$1,NULL,$6);}
	    | READ'('ID2')' ';' {char c[10];strcpy(c,"READ");$$=makeNameNode(c,$3,NULL,NULL);}
	    | READ'(' ID2'['E']' ')' ';' {char c[10];strcpy(c,"READ");$$=makeNameNode(c,$3,NULL,NULL);}
	    | WRITE'('E')' ';' {printf("going to make write node\n"); char c[10];strcpy(c,"WRITE");$$=makeNameNode(c,$3,NULL,NULL);printf("made write node\n");}
	  ...
	  E: E '+' E	{char c[10];strcpy(c,"+");$$=makeNameNode(c,$1,NULL,$3);}
	   ...
	   | E '#' E 	{char c[10];strcpy(c,"#");$$=makeNameNode(c,$1,NULL,$3);}
	   | NUM       {$$=$1;}
	   | ID2       {$$=$1;printf("ID2 detected\n");}
	   | ID2'['E']' {char c[10];strcpy(c,"$");$$=makeNameNode(c,$1,NULL,$3);}
	   ;
%%
